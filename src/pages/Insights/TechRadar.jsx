...
import TechRadarStack from '../../components/insightSection/TechRadar/TechRadarStack';
import { insightsData } from '../../components/insightSection/insightsData';
import { Radar } from 'lucide-react';

const TechRadar = () => {
  const data = insightsData.techRadar;
  ...
  return (
    <div className="bg-background-main min-h-screen">
      ...
      {/* Technology Stack Section - 8 Cards with 6 Technologies Each */}
      <TechRadarStack categories={data.categories} />
    </div>
  );
};
